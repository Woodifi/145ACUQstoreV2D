...
const ACTION_LABELS = Object.freeze({
  ...
  sync_encryption_enabled: 'Cloud sync encryption enabled',
  sync_encryption_reset:   'Cloud sync encryption reset',
  keys_rotated:            'Encryption keys rotated',
...
const ACTION_CATEGORY = Object.freeze({
  ...
  sync_encryption_enabled: 'security',
  sync_encryption_reset:   'security',
  keys_rotated:            'security',
